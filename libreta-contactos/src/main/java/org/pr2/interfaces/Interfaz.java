...
public class Interfaz{
     ...
     *  @param args puede ser <i>add nombre contacto</i> (p.ej. <i>add Juan* 
     * 653421367</i>) para añadir contacto, o <i>show</i>para mostrar todos* los contactos de la libreta. */
